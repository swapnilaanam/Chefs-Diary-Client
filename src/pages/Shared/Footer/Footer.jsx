...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-neutral text-primary-content">
            <div>
                <TbChefHat className="text-7xl font-bold" />
                <p className="font-bold">
                    <span className="text-4xl">Chef's Diary</span>
                    <br />
                    <br />
                    <span className="text-lg">Making Delicious Food Recipes Since 2012</span>
                </p>
                <p className="mt-3 text-base">Copyright © 2023 - All right reserved by Chef's Diary</p>
            </div>
            <div>
